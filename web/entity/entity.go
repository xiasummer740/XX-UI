// Package entity defines data structures and entities used by the web layer of the XX-UI panel.
package entity
...
// AllSetting contains all configuration settings for the XX-UI panel including web server, Telegram bot, and subscription settings.
